...
function initRenderer(additionalProperties) {
    ...
    renderer.shadowMap.enabled = true;
    document.getElementById("mjs").appendChild(renderer.domElement);
...
function initCamera(initialPosition) {
    var position = (initialPosition !== undefined) ? initialPosition : new THREE.Vector3(0,0,5);
...
function initDefaultLighting(scene, initialPosition) {
    var position = (initialPosition !== undefined) ? initialPosition : new THREE.Vector3(nit.position);
